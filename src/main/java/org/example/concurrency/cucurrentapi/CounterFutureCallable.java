 ...
 */
public class CounterFutureCallable {
    ...
    public static void main(String[] args) {
        ...
        try {
            /**
             * get() with no seconds will wait till the execution is completed
             */
            System.out.println("counterFutureResult is -> "+counterFutureResult.get(10, TimeUnit.SECONDS));// Wait until it Retrieves the result of a task
